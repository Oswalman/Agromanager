...
class Terminos extends StatefulWidget {
  Terminos({Key key, this.auth, this.userId, this.logoutCallback})
      : super(key: key);
  ...
  @override
  State<StatefulWidget> createState() => new TerminosWidget();
}

class TerminosWidget extends State<Terminos> {
  @override
                ...
                child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text('POLÍTICA DE REEMBOLSO Y GARANTÍA'),
                        Text(
