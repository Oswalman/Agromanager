...
import 'package:Agromanager/UI/Views/Contabilidad/Ingresos/TipoExternos/AddTipoExternos.dart';
import 'package:Agromanager/UI/Views/Contabilidad/Ingresos/TipoExternos/DetallesExternos.dart';
...
class TipoExternos extends StatefulWidget {
  TipoExternos({Key key, this.auth, this.userId, this.logoutCallback})
      : super(key: key);
  ...
  @override
  State<StatefulWidget> createState() => new TipoExternosWidget();
}

class TipoExternosWidget extends State<TipoExternos> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppbarWidget(title: "EXTERNOS"),
