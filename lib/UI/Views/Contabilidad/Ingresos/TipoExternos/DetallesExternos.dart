...
import 'package:Agromanager/UI/Views/Contabilidad/Gastos/TipoEmpleados/NewEmpleados.dart';
...
class DetallesExternos extends StatefulWidget {
  DetallesExternos(
  ...
  @override
  State<StatefulWidget> createState() => new DetallesExternosWidget();
}

class DetallesExternosWidget extends State<DetallesExternos> {
