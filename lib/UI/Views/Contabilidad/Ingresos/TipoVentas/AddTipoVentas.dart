...
class AddTipoVentas extends StatefulWidget {
  AddTipoVentas({Key key, this.auth, this.userId, this.logoutCallback})
      : super(key: key);
  ...
  @override
  _AddTipoVentasState createState() => _AddTipoVentasState();
}

class _AddTipoVentasState extends State<AddTipoVentas> {
