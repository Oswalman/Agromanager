...
import 'package:Agromanager/UI/Views/Contabilidad/Gastos/TipoAlimentacion/NewAlimentacion.dart';
...
class DetallesAlimentacion extends StatefulWidget {
  DetallesAlimentacion(
  ...
  @override
  State<StatefulWidget> createState() => new DetallesAlimentacionWidget();
}

class DetallesAlimentacionWidget extends State<DetallesAlimentacion> {
