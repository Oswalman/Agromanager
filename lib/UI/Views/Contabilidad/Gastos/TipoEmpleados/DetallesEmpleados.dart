...
class DetallesEmpleados extends StatefulWidget {
  DetallesEmpleados(
  ...
  @override
  State<StatefulWidget> createState() => new DetallesEmpleadosWidget();
}

class DetallesEmpleadosWidget extends State<DetallesEmpleados> {
